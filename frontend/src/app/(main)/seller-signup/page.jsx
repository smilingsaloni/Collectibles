...
const SellerSignup = () => {
  ...
  const signupForm = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      // Convert productCategories from comma-separated string to array
      const dataToSubmit = {
        ...values,
        productCategories: values.productCategories.split(',').map(cat => cat.trim()).filter(cat => cat !== '')
      };

      axios.post('http://localhost:5000/seller/add', dataToSubmit)
        .then((result) => {
  ...
  return (
    <div className='mx-auto flex items-center justify-center min-h-screen bg-gray-50'>
      <div className="mt-7 bg-white border border-gray-200 rounded-xl w-[40%] shadow-2xs">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold text-gray-800">Seller Sign up</h1>
          ...
          <div className="mt-5">
            ...
            <form onSubmit={signupForm.handleSubmit}>
              <div className="grid gap-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      name="businessName"
                      onChange={signupForm.handleChange}
                      value={signupForm.values.businessName}
                      className="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                      required=""
                  ...
                  {
                    (signupForm.errors.businessName && signupForm.touched.businessName) && (
                      <p className="text-xs text-red-600 mt-2" id="businessName-error">
                        {signupForm.errors.businessName}
                      </p>
                    )
                  }
                </div>
                ...
                {/* Form Group */}
                <div>
                  <label htmlFor="businessAddress" className="block text-sm mb-2">
                    Business Address
                  </label>
                  <div className="relative">
                    <textarea
                      ...
                      onChange={signupForm.handleChange}
                      value={signupForm.values.businessAddress}
                      className="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                ...
                {/* Form Group */}
                <div>
                  <label htmlFor="productCategories" className="block text-sm mb-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={signupForm.handleChange}
                      value={signupForm.values.productCategories}
                      placeholder="e.g. Electronics, Books, Clothing"
                      className="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                      aria-describedby="productCategories-error"
                    />
                  </div>
                </div>
